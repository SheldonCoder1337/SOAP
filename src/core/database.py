...
from src.common import setup_logger, hashstr, is_text_pdf
...
class DataBaseManager:
    ...
    """ Database Manager for knowledge base operations
    Handles creation, deletion, querying, and maintenance of knowledge databases,
    including file processing and vector embeddings management.
    """
    ...
    def __init__(self, config=None) -> None:
        ...
        if self.config.enable_knowledge_base:
            ...
            if self.config.enable_knowledge_graph:
                from src.core.graphdb import GraphDB
                self.graph_base = GraphDB(self.config, self.embed_model)
    ...
    def add_files(self, db_id, files, params=None):
        ...
        from src.common.chunker import chunk
    ...
    def read_text(self, file, params=None):
        ...
        if file.endswith(".pdf"):
            if is_text_pdf(file):
                from src.core.reader import pdfreader
            ...
            from src.core.reader import plainreader
