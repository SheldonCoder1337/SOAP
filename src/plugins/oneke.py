        ...
        schema = [
            {
                "entity_type": "Herbs",
                "attributes": {
                    "name": "食品的名称，包括品牌名、通用名称或专业化学名",
                    "class": "食品所属的类型，例如水果、蔬菜、肉类、谷物、调料、添加剂、益生菌等",
                    "ingredients": "食品的主要成分，详细列出包括天然成分、添加剂、保鲜剂、营养强化剂等",
                    "function": "食品的营养成分，概括其提供的能量和主要营养素，如蛋白质、脂肪、碳水化合物、维生素和矿物质",
                    "processed": "食品的处理或制备方法，包括日常烹饪、加工处理及实验室制备方式等"
                }
            }
        ]
