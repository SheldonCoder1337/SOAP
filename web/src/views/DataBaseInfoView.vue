...
<div>
  <HeaderComponent
    :title="database.name || $t('DatabaseInfo_header_desc')"
  >
    ...
    <template #actions>
      <a-button type="primary" @click="backToDatabase">
        <LeftOutlined /> {{$t('return')}}
      </a-button>
      <a-button type="primary" danger @click="deleteDatabse">
        <DeleteOutlined /> {{$t('delete_database')}}
      </a-button>
    </template>
  </HeaderComponent>
      ...
      <a-tab-pane key="add">
        ...
        <div class="db-tab-container">
          ...
          <div class="actions">
            ...
            <a-button @click="handleRefresh" :loading="state.refrashing">{{$t('refresh')}}</a-button>
          </div>
          ...
          <div class="query-result-container">
            <div class="query-action">
              ...
              <a-button class="btn-query" @click="onQuery" :disabled="queryText.length == 0">
                <span v-if="!state.searchLoading"><SearchOutlined /> {{$t('retrieve')}}</span>
