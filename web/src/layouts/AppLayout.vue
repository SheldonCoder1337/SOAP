...
<template>
  <div class="app-layout" :class="{ 'use-top-bar': layoutSettings.useTopBar }">
    ...
    <div class="header" :class="{ 'top-bar': layoutSettings.useTopBar }">
      ...
      <div class="nav">
        ...
        <RouterLink to="/database" class="nav-item" active-class="active">
          ...
          <span class="text">{{ $t('knowledge') }}</span>
        </RouterLink>
      ...
      <div class="github nav-item">
        <a href="https://github.com/sheldoncoder1337/" target="_blank">
          <GithubOutlined  class="icon" style="color: #222;"/>
        </a>
      </div>

      <div class="language nav-item">
        <GlobalOutlined class="icon" style="color: #222;" @click="switchLanguage"/>
      </div>
    ...
    <div class="header-mobile">
      <RouterLink to="/chat" class="nav-item" active-class="active">{{ $t('chat') }}</RouterLink>
      <RouterLink to="/database" class="nav-item" active-class="active">{{ $t('knowledge') }}</RouterLink>
      <RouterLink to="/setting" class="nav-item" active-class="active">{{ $t('setting') }}</RouterLink>
    </div>
